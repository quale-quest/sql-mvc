...
exports.generate = function (program) {
	...
	if (checkRootDirectory(target)) {
		...
		setTimeout(function () {
			...
			pack.dependencies["socketstream"] = "0.3.11";
			...
			pack.dependencies["winston"] = "^1.0.1";      
			pack.dependencies["hogan"] = "^1.0.2";      
			pack.dependencies["deasync"] = "*";      	
			pack.dependencies["path"] = "0.12.7";      	
			pack.dependencies["sql-mvc-ui-dark"] = "^0.0.1";      			
